...
from core.adapters.retrieval.chroma_client import chroma_legal_client
...
class LegalIndexBuilder:
    ...
    def __init__(self):
        self.data_dir = str(APP_DATA_DIR / "legal")
        self.knowledge_base_md = str(APP_DATA_DIR / "rag" / "knowledge_base" / "律师-法律知识库.md")
