...
class AgentLawyerRequest(CoreModel):
    text: str = Field(..., min_length=1)
    session_id: Optional[str] = Field(default=None, alias="sessionId")


class AgentTeacherRequest(CoreModel):
    text: str = Field(..., min_length=1)
    session_id: Optional[str] = Field(default=None, alias="sessionId")


class AgentWriterRequest(CoreModel):
    text: str = Field(..., min_length=1)
    session_id: Optional[str] = Field(default=None, alias="sessionId")


class AgentProgrammerRequest(CoreModel):
    text: str = Field(..., min_length=1)
    session_id: Optional[str] = Field(default=None, alias="sessionId")
...
class AgentLawyerResponse(CoreModel):
    success: bool = True
    answer: str
    session_id: str = Field(alias="sessionId")
