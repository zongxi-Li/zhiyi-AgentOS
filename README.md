...
**详细说明**: 请参考 [创新点完整实现说明](./开发文档/docs/创新点完整实现说明.md) 和 [创新功能API文档](./开发文档/docs/创新功能API文档.md)

### 📚 开发文档索引

为了便于查阅和管理，所有项目文档已统一整理到 **开发文档** 文件夹中，按照功能和使用场景进行分类：

#### 📋 项目概述类文档
- [📖 README.md](./README.md) - 项目总览、核心功能、快速开始
- [📝 工作日志](./开发文档/docs-overview/工作日志.md) - 开发过程记录、问题解决记录
- [📊 PUSH_SUMMARY_2026-04-14.md](./开发文档/docs-overview/PUSH_SUMMARY_2026-04-14.md) - 代码提交汇总、阶段性成果

#### 🏗️ 技术架构类文档
- [📐 AGENT_ARCHITECTURE.md](./开发文档/docs-architecture/AGENT_ARCHITECTURE.md) - Agent架构蓝图、技术选型、流程图
- [📋 CHECK_REPORT.md](./开发文档/docs-architecture/CHECK_REPORT.md) - 项目阶段报告、开发进度、验收标准
- [🔧 backend/README.md](./backend/README.md) - 后端技术栈、构建说明
- [🤖 agent/README.md](./agent/README.md) - AI服务配置、环境变量设置

#### 👨‍💻 开发指南类文档
- [📋 TODO.md](./开发文档/docs-development/TODO.md) - 开发任务清单、进度跟踪、优先级
- [🧹 README-清除浏览器缓存.md](./开发文档/docs-development/README-清除浏览器缓存.md) - 前端缓存清理指南

#### 🚀 创新功能类文档
- [🌐 README-联邦学习创新点.md](./开发文档/docs-innovation/README-联邦学习创新点.md) - 联邦学习全局最优模型系统

#### 📄 PDF技术文档
- [📘 KFC-Agent文档v7.pdf](./开发文档/docs-pdfs/KFC-Agent文档v7.pdf) - Agent系统详细规范
- [📗 麒麟 AI SDK 开发指南.pdf](./开发文档/docs-pdfs/麒麟 AI SDK 开发指南.pdf) - 麒麟AI SDK使用指南

### 📖 完整技术文档集

**详细技术文档**: 我们提供了详实完整的技术文档，包含技术和介绍内容：

- [📑 文档索引](./开发文档/docs/Kinlin-AI技术文档-索引.md) - 文档导航和快速查找
- [📋 项目概述和技术架构](./开发文档/docs/Kinlin-AI技术文档-01-项目概述.md) - 项目简介、架构设计、技术栈
- [⚙️ 核心功能详解](./开发文档/docs/Kinlin-AI技术文档-02-核心功能详解.md) - 文本对话、语音对话、角色管理、RAG等核心功能
- [🚀 创新功能详解](./开发文档/docs/Kinlin-AI技术文档-03-创新功能详解.md) - 数字人、情感感知、角色融合、**联邦学习全局最优模型**等创新功能
- [🔧 部署和运维指南](./开发文档/docs/Kinlin-AI技术文档-04-部署和运维指南.md) - 部署步骤、运维管理、故障排查
- [📡 API接口文档](./开发文档/docs/Kinlin-AI技术文档-05-API接口文档.md) - 完整的API接口说明和使用示例
- ⭐ [🌐 联邦学习专题文档](./开发文档/docs/Kinlin-AI技术文档-06-联邦学习专题.md) - 联邦学习全局最优模型系统完整说明

**快速开始**: 建议先阅读 [文档索引](./开发文档/docs/Kinlin-AI技术文档-索引.md) 了解文档结构，然后根据您的角色和需求选择相应的文档。

**🌟 特别推荐**: 查看 [联邦学习专题文档](./开发文档/docs/Kinlin-AI技术文档-06-联邦学习专题.md) 了解业界首创的RAG联邦优化技术！
